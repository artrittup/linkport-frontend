...
const typeFilters = ['All', 'Jobs', 'Internships', 'Projects', 'Challenges']
...
export default function CandidateOpportunities() {
  ...
  const allOpportunities = useMemo(
    () => [...apiOpportunities, ...mockOpportunities],
    [apiOpportunities],
  )
  ...
  }, [activeType, allOpportunities, search, workStyle])
  ...
  return (
    <CandidateLayout title="Opportunities">
      ...
      <section className="mt-8 min-w-0 max-w-full" aria-live="polite">
        ...
        {projectsError && (
          <p className="mb-5 rounded-xl border border-[#facc15]/25 bg-[#facc15]/5 px-4 py-3 text-sm text-[#fde68a]">
            Company projects are temporarily unavailable. Jobs and community opportunities are still available.
          </p>
        )}
