...
export default function MyApplications() {
  ...
  const filteredApplications = mockMyApplications.filter(
    (application) =>
      (!query ||
  ...
  const stats = [
    { label: 'Total Applications', value: mockMyApplications.length },
    { label: 'Pending', value: mockMyApplications.filter((item) => item.status === 'Pending').length },
    { label: 'Accepted', value: mockMyApplications.filter((item) => item.status === 'Accepted').length },
    { label: 'Rejected', value: mockMyApplications.filter((item) => item.status === 'Rejected').length },
  ]
